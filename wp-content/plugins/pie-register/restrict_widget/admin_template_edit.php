...
if(!isset($_GET['pie_id']) || empty($wp_registered_widgets[$_GET['pie_id']]))	
	...
	if(!empty($_GET['option'])){
		...
		echo '<div class="pr_rw_breadcrums"><a href="', esc_url($this->pr_rw_admin_url) ,'">'.(__("Custom widgets","piereg")).'</a> <span class="piereg_breadcrum_bulet">&nbsp;&nbsp;&nbsp;</span> '.(__("Customize","piereg")).' "'.$widget['name'].'"</div>';	
