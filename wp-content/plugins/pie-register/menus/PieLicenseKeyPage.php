        ...
        <div class="settings">
            ...
            <form method="post" action="">
                ...
                <div class="fields fields2">
                    ...
                    <p><a href="https://store.genetech.co/" target="_blank" title="Purchase License Key"><?php _e("Already Purchased",'piereg') ?>?</a> or <a href="http://pieregister.com/" target="_blank" title="Purchase License Key"><?php _e("Click here to Purchase",'piereg') ?></a></p>
                </div>
