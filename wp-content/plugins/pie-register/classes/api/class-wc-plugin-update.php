...
class API_Manager_Example_Update_API_Check {
	...
	public function expired_license_error_notice( $message ){
		...
		echo sprintf( '<div id="message" class="error"><p>' . __( 'The license key for %s has expired. You can reactivate or purchase a license key from your account <a href="%s" target="_blank">dashboard</a>.', $this->piereg_text_domain ) . '</p></div>', $plugin_name, $this->renew_license_url ) ;
	...
	public function cancelled_subscription_error_notice( $message ){
		...
		echo sprintf( '<div id="message" class="error"><p>' . __( 'The subscription for %s has been cancelled. You can renew the subscription from your account <a href="%s" target="_blank">dashboard</a>. A new license key will be emailed to you after your order has been completed.', $this->piereg_text_domain ) . '</p></div>', $plugin_name, $this->renew_license_url ) ;
	...
	public function pending_subscription_error_notice( $message ){
		...
		echo sprintf( '<div id="message" class="error"><p>' . __( 'The subscription for %s is still pending. You can check on the status of the subscription from your account <a href="%s" target="_blank">dashboard</a>.', $this->piereg_text_domain ) . '</p></div>', $plugin_name, $this->renew_license_url ) ;
	...
	public function download_revoked_error_notice( $message ){
		...
		echo sprintf( '<div id="message" class="error"><p>' . __( 'Download permission for %s has been revoked possibly due to a license key or subscription expiring. You can reactivate or purchase a license key from your account <a href="%s" target="_blank">dashboard</a>.', $this->piereg_text_domain ) . '</p></div>', $plugin_name, $this->renew_license_url ) ;
	...
	public function switched_subscription_error_notice( $message ){
		...
		echo sprintf( '<div id="message" class="error"><p>' . __( 'You changed the subscription for %s, so you will need to enter your new API License Key in the settings page. The License Key should have arrived in your email inbox, if not you can get it by logging into your account <a href="%s" target="_blank">dashboard</a>.', $this->piereg_text_domain ) . '</p></div>', $plugin_name, $this->renew_license_url ) ;
