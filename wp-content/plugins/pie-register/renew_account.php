...
global $wp_session;
		...
		if($this->pie_post_array['success'] != "")
			$pr_data .= '<p class="msg_div piereg_message">'.apply_filters('piereg_messages', __($this->pie_post_array['success'],"piereg")).'</p>';
		elseif($this->pie_post_array['error'] != "")
			$pr_data .= '<p class="msg_div piereg_login_error">'.apply_filters('piereg_messages', __($this->pie_post_array['error'],"piereg")).'</p>';
